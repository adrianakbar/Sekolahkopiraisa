  ...
  return (
    <>
        ...
        <section className="flex flex-col md:flex-row gap-8 items-center container mx-auto mt-10 md:mt-20">
          <div className="md:w-1/2">
            ...
            <p className="text-gray-700 mb-4">
              ...
              <em>social entrepreneurship</em> yang berfokus pada fungsi edukatif
              dan bisnis pengelolaan kopi sebagai komoditas utamanya.
            </p>
            <p className="text-gray-700">
              BUMDESMA RAISA merupakan hasil kolaborasi tiga desa di Kecamatan
              Sumberwringin—Desa Sumberwringin, Rejoagung, dan Sukorejo—yang berdiri
              sejak 2021.
              <br />
              <br />
      ...
      <section className="flex flex-col lg:flex-row gap-8 container mx-auto px-4">
        ...
        <div className="lg:w-2/3 w-full p-6">
          ...
          <p className="text-gray-700 italic mb-6">
            ...
            berkelanjutan serta penguatan branding Bondowoso Republik Kopi (BRK).”
          </p>
      ...
      <section className="container mx-auto px-4">
        <h3 className="text-2xl font-semibold text-gray-800 mb-4">Pengurus Inti</h3>
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
          <MemberCard id={1} image="/assets/tk2.png" name="Raisa" position="Founder" />
          <MemberCard id={2} image="/assets/tk2.png" name="Raisa" position="Co-Founder" />
          <MemberCard id={3} image="/assets/tk2.png" name="Raisa" position="Co-Founder" />
          <MemberCard id={4} image="/assets/tk2.png" name="Raisa" position="Co-Founder" />
        </div>
      </section>

      {/* Bagian Pokja */}
      <section className="container mx-auto mt-10 px-4">
        <h3 className="text-2xl font-semibold text-gray-800 mb-4">Bagian Pokja</h3>
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
          <MemberCard id={1} image="/assets/tk2.png" name="Raisa" position="Founder" />
          <MemberCard id={2} image="/assets/tk2.png" name="Raisa" position="Co-Founder" />
          <MemberCard id={3} image="/assets/tk2.png" name="Raisa" position="Co-Founder" />
