...
export default function Navbar({ navbarItems }: { navbarItems: NavbarItem[] }) {
  ...
  useEffect(() => {
    ...
    // Add event listener to document to detect clicks outside the dropdown
  ...
  // Toggle dropdown - this is the key function we're fixing
  const toggleDropdown = (e: React.MouseEvent) => {
    // Prevent event from bubbling up to the document, which would immediately close the dropdown
    e.stopPropagation();
      ...
      <div className="hidden md:flex items-center space-x-4">
        {user ? (
          <div className="relative">
            ...
            {isDropdownOpen && (
              <div onClick={(e) => e.stopPropagation()} className="absolute right-0 mt-[17px]">
                <Dropdown
